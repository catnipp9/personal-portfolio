...
export const AboutMe = () => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      (entries) => {
        ...
        if (entry.isIntersecting) {
          ...
          // React 18 and StrictMode might cause issues with returning clearTimeout directly in the effect setup
          // The cleanup function for setTimeout should be returned by the effect callback.
          // However, since we unobserve, this specific timer cleanup might not be strictly necessary
          // if the component itself isn't unmounted immediately after. For robustness:
    ...
    return () => {
      ...
      // to prevent any potential memory leaks, though unobserving might be sufficient.
      observer.disconnect();
    };
      ...
      <div className="container">
        ...
        <div className={`row about-row align-items-center ${rowAnimationBaseClasses} ${isLoaded ? `${rowLoadedStateClasses} ${delay200}` : rowInitialStateClasses}`}>
          ...
          <div className="col-md-6 about-text-col d-flex flex-column justify-content-center order-2 order-md-1">
            ...
            <p>
              My utility belt is packed with skills in <span className="creative-text">full-stack wizardry</span>, <span className="creative-text">UI/UX enchantments</span>, and <span className="creative-text">cloud sorcery</span>, and I&rsquo;m a <span className="creative-text">master of artifacts</span> like React, Node.js, and Git.
              As a team player in any fellowship, I enjoy turning complex challenges into user-friendly, super-charged applications by understanding the <span className="creative-text">ancient &lsquo;why&rsquo;</span> of each feature.
            </p>
          </div>
        </div>
